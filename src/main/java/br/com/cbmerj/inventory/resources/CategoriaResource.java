...
public class CategoriaResource {
	...
	public ResponseEntity<List<Categoria>> findAllOriginal() {
	...
	public ResponseEntity<Page<CategoriaDTO>> findPage(
		...
		Page<CategoriaDTO> listDto = service.findPage(page, linesPerPage, orderBy, direction).map(obj -> new CategoriaDTO(obj));
		return ResponseEntity.ok().body(listDto);
	}
